...
* link:dummy-assets[Dummy assets]: Not directly related to one particular specification per se, but this showroom contains a number of generic dummy assets which may be needed to refer to when you e.g. test your implementation of a given specification. 
