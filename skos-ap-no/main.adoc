...
* The demo concepts #will be# automatically harvested to and thus also (#not yet#) be findable via https://demo.fellesdatakatalog.digdir.no/concepts?q=demoCpt[the demo portal].
