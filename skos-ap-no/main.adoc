...
* The demo concepts #(when the demo catalog conforms to v.2 of SKOS-AP-NO-Begrep) will be# automatically harvested to and thus published via https://jimjyang.github.io/showroom/#about-demo-catalog[the demo catalog].
...
== Some explanations of the demo concepts [[explanations]]
...
=== Explanation - associative concept relations [[associative-relations]]

_#... more to come ...#_ 

=== Explanation - hierarchical concept relations [[hierarchical-relations]]
