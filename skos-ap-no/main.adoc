...
* The demo concepts #(when the demo catalog conforms to v.2 of SKOS-AP-NO-Begrep) will be# automatically harvested to and thus published via the #demo catalog#.
