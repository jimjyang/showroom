...
* A concept may refer to a classification as its value range. This is demonstrated by https://w3id.org/demo-resources/demo-concepts#demoCpt2["demo concept 2"], the property "value range" (`skosno:valueRange`).
* _#... more to come ...#_ 
