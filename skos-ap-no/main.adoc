...
_SKOS-AP-NO-Begrep is the Norwegian application profile of W3C's https://www.w3.org/2004/02/skos/[SKOS ↗, window="_blank", role="ext-link"], for describing and publishing concepts and concept collections._
...
*** Together with "demo concept 2" which illustrates the usage of all the other properties, they illustrate therefore how to _syntactically_ use all the properties a concept description may have in accordance with SKOS-AP-NO-Begrep v.2.x. 

.Click for the concept diagrams.
[%collapsible]
====
.Concept diagrams (using the notations as in relevant ISO-standards). 
