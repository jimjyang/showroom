...
* The demo information models are automatically harvested to and thus findable via https://demo.fellesdatakatalog.digdir.no/informationmodels?q=demomodel[the demo portal ↗, window="_blank", role="ext-link"]. 
