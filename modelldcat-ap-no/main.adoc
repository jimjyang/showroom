...
In this part of the showroom we will demonstrate the usage of https://data.norge.no/specification/modelldcat-ap-no[the Norwegian application profile of DCAT (ModellDCAT-AP-NO)], for describing information models.
