...
= image:../images/Digdir.png[Digdir,100,100] showroom with demo permanent/persistent and dereferenced URIs
_https://digdir.no[Norwegian Digitalisation Agency ↗, window="_blank", role="ext-link"]_
:doctype: book
:docinfo: shared
:docinfodir: ../docs
:icons: font
