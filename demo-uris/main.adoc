...
* `Accept-language: nb` will redirect to the HTML representation in Norwegian bokmål, of the resources identified by that URI.

* `Accept-language: en` will redirect to the HTML representation in English, of the resources identified by that URI.
