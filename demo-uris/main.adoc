...
_https://www.digdir.no/standarder/peikarar-til-offentlege-ressursar-pa-nett/1492[The Norwegian URI-standard ↗, window="_blank", role="ext-link"] is based on EU's https://joinup.ec.europa.eu/collection/semantic-interoperability-community-semic/document/10-rules-persistent-uris[10 Rules for Persistent URIs ↗, window="_blank", role="ext-link"]._ 
