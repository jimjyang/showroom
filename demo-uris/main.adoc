...
= Jim's showroom with demo URIs and dereferenced URIs
:doctype: book
:docinfo: shared
:docinfodir: ../docs
:icons: font
...
Welcome to the showroom with dereferenced demo URIs, demonstrating a possible implementation of https://www.digdir.no/standarder/peikarar-til-offentlege-ressursar-pa-nett/1492[the Norwegian URI-standard ↗, window="_blank", role="ext-link"]! 

_The Norwegian URI-standard is based on EU's https://joinup.ec.europa.eu/collection/semantic-interoperability-community-semic/document/10-rules-persistent-uris[10 Rules for Persistent URIs ↗, window="_blank", role="ext-link"]._ 
...
We use the services provided by w3id.org, and define https://github.com/perma-id/w3id.org/tree/master/demo-resources[RewriteRules for dereferencing our demo URIs ↗, window="_blank", role="ext-link"]. 
...
== Why are permanent URIs important?
