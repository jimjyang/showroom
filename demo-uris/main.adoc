...
= Jim's showroom with demo permanent/persistent and dereferenced URIs
:doctype: book
:docinfo: shared
:docinfodir: ../docs
:icons: font
...
Welcome to the showroom with permanent/persistent and dereferenced demo URIs, demonstrating a possible implementation of https://www.digdir.no/standarder/peikarar-til-offentlege-ressursar-pa-nett/1492[the Norwegian URI-standard ↗, window="_blank", role="ext-link"]! 
