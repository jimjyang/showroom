...
* The RDF Turtle representation of the data catalog containing this demo dataset, is automatically harvested in to the demo catalog and thus https://demo.fellesdatakatalog.digdir.no/datasets?q=demodataset[searchable/findable via the demo catalog, window="_blank", role="ext-link"].
