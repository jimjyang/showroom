...
In this showroom we have a demo https://data.norge.no/specification/xkos-ap-no#Klassifikasjon[classification (`skos:ConceptScheme`),  window="_blank", role="ext-link", content="\f08e"] with its https://data.norge.no/specification/xkos-ap-no#Klassifikasjonsniv%C3%A5[classification levels (`xkos:ClassificationLevel`), window="_blank", role="ext-link", content="\f08e"] and https://data.norge.no/specification/xkos-ap-no#Kategori[categories (`xkos:ClassificationLevel`), window="_blank", role="ext-link", content="\f08e"],  illustrated in <<img-demo-classification>>. 
...
** In our https://jimjyang.github.io/showroom/dcat-ap-no/[showroom with demo datasets], we demonstrate how to describe this demo classification as a machine-readable open dataset, and to make it https://demo.fellesdatakatalog.digdir.no/datasets?q=demodataset[findable via the demo portal].
