...
In this showroom we have a demo https://data.norge.no/specification/xkos-ap-no#Klassifikasjon[classification (`skos:ConceptScheme`) ↗,  window="_blank", role="ext-link", content="\1F855"] with its https://data.norge.no/specification/xkos-ap-no#Klassifikasjonsniv%C3%A5[classification levels (`xkos:ClassificationLevel`) ↗, window="_blank", role="ext-link", content="\1F855"] and https://data.norge.no/specification/xkos-ap-no#Kategori[categories (`xkos:ClassificationLevel`) ↗, window="_blank", role="ext-link", content="\1F855"],  illustrated in <<img-demo-classification>>. 
