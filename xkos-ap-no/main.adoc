...
** This will be demonstrated in our link:../skos-ap-no[showroom with demo concepts]. 
** Classifications should therefore be made available, also machine-readably. 
...
** This will be demonstrated in our link:../modelldcat-ap-no/[showroom with demo information models]. 
** Classifications should therefore be made available, also machine-readably. 
