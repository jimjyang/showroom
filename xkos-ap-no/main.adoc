...
In this showroom we have a demo https://data.norge.no/specification/xkos-ap-no#Klassifikasjon[classification, window="_blank", role="ext-link", content="\f08e"] with its https://data.norge.no/specification/xkos-ap-no#Klassifikasjonsniv%C3%A5[classification levels, window="_blank", role="ext-link", content="\f08e"] and https://data.norge.no/specification/xkos-ap-no#Kategori[categories, window="_blank", role="ext-link", content="\f08e"],  illustrated in <<img-demo-classification>>. 
