...
In this showroom we have a demo https://data.norge.no/specification/xkos-ap-no#Klassifikasjon[classification, window="_blank", role="ext-link", class="styled__ExternalLinkIcon-sc-19aiwhb-2 dZPOaH"] with its https://data.norge.no/specification/xkos-ap-no#Klassifikasjonsniv%C3%A5[classification levels, window="_blank", role="ext-link", class="styled__ExternalLinkIcon-sc-19aiwhb-2 dZPOaH"] and https://data.norge.no/specification/xkos-ap-no#Kategori[categories, window="_blank", role="ext-link", class="styled__ExternalLinkIcon-sc-19aiwhb-2 dZPOaH"],  illustrated in <<img-demo-classification>>. 
