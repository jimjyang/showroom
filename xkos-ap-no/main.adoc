...
Some examples of cross-references between classifications and concepts: 
...
Some examples of cross-references between classifications and datasets:
...
Some examples of cross-references between classifications and information models:
...
Some examples of cross-references between classifications and services/events:
