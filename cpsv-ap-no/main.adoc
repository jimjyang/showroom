...
In this showroom we have a https://w3id.org/demo-resources/demo-services-events[catalog of demo services and demo events]: 
...
Some examples of cross-references between services/events models and classifications: 

* _#... more to come ...#_  

Some examples of cross-references between services/events models and concepts: 

* _#... more to come ...#_  

Some examples of cross-references between services/events models and datasets: 

* _#... more to come ...#_  

Some examples of cross-references between services/events models and information models: 
